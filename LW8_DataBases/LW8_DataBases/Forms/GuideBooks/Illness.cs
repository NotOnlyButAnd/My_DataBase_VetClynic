...
namespace LW8_DataBases
{
    public partial class Illness : Form
    {
        ...
        {
            // TODO: данная строка кода позволяет загрузить данные в таблицу "veterinary_ClinicDataSet.Illness". При необходимости она может быть перемещена или удалена.
            this.illnessTableAdapter.Fill(this.veterinary_ClinicDataSet.Illness);
