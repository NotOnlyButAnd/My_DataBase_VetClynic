...
namespace LW8_DataBases
{
    public partial class Breeds : Form
    {
        ...
        {
            // TODO: данная строка кода позволяет загрузить данные в таблицу "veterinary_ClinicDataSet.Breeds". При необходимости она может быть перемещена или удалена.
            this.breedsTableAdapter.Fill(this.veterinary_ClinicDataSet.Breeds);
        ...
        private void saveChangesToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                // обновляем БД
                breedsTableAdapter.Update(veterinary_ClinicDataSet);
            }
            catch (Exception ex)
            {
